...
namespace structures
{
	...
	/// <typeparam name = "K"> Kluc prvku. </typeparam>
	...
	template<typename K, typename T>
	inline Treap<K, T>* Treap<K, T>::clone() const
	{
	...
	inline T Treap<K, T>::remove(const K & key)
	{
		...
		if (found)
		{
			// TODO Dostan node rotaciami dole?
			extractNode(node);
