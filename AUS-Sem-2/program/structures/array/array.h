...
namespace structures 
{
	...
	Array<T>& Array<T>::operator=(const Array<T>& other)
	{
		if (this != &other)
		{
			// V skutocnosti by bez tohto nebol problem, vektor si zmeni velkost v pohode
			// Filozofia Array je ale taka, ze jeho velkost sa nikdy nemeni
	...
	{
		// Polia su rovnake, ked ich vektory su rovnake
	...
	{
		DSRoutines::rangeCheckExcept(index, size_, "Array<T>::mapFunction - Array index out of range!");
